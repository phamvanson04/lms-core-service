...
public enum ErrorCode {
  ...
  INVALID_EMAIL(
      1002,
      "INVALID_EMAIL",
      "Email must be input a valid format (e.g., user@example.com)",
  ...
  INVALID_PHONE_NUMBER_VN(
      1327,
      "INVALID_PHONE_NUMBER_VN",
      "Phone number must be input a valid format for Vietnam +84",
      HttpStatus.BAD_REQUEST),
  ...
  SAME_PASSWORD(
      ...
      HttpStatus.BAD_REQUEST),
  PHONE_EXISTED(1119, "PHONE_EXISTED", "Phone number is already input use", HttpStatus.CONFLICT),
  ...
  NOT_COURSE_INSTRUCTOR(
      ...
      HttpStatus.FORBIDDEN),
  NOT_ENROLLED(
      1203, "NOT_ENROLLED", "You must be enrolled input this course", HttpStatus.FORBIDDEN),
  ...
  ROLE_NOT_FOUND(1210, "ROLE_NOT_FOUND", "Role not found input the system", HttpStatus.FORBIDDEN),
  ...
  ALREADY_ENROLLED(
      1404, "ALREADY_ENROLLED", "Already enrolled input this course", HttpStatus.CONFLICT),
  ...
  DUPLICATE_LESSON_ORDER(
      1407,
      "DUPLICATE_LESSON_ORDER",
      "Lesson order already exists input this course",
      HttpStatus.CONFLICT),
  ...
  LOGIN_ATTEMPTS_EXCEEDED(
      1531,
      "LOGIN_ATTEMPTS_EXCEEDED",
      "Too many login attempts. Please try again input 15 minutes",
      HttpStatus.TOO_MANY_REQUESTS),
